...
public class DrivetrainSubsystem extends SubsystemBase {
  ...
  public static Rotation2d gyroHeading;

  public static final double MAX_VELOCITY_METERS_PER_SECOND = 5500.0 / 60.0 * //WAS 6380
  ...
  //BLACKBIRD - changed to static - nope not anymore
  ...
  private static final PigeonIMU m_pigeon = new PigeonIMU(DRIVETRAIN_PIGEON_ID);
...
//  private final AHRS m_navx = new AHRS(SPI.Port.kMXP, (byte) 200); // NavX connected over MXP
  ...
  //BLACKBIRD
  private final SwerveDriveOdometry odometer = new SwerveDriveOdometry(m_kinematics, new Rotation2d());
  ...
  public void resetEverything() {
    // FIXME Remove if you are using a Pigeon
        ...
        m_frontLeftModule.resetCurrentAngle();
        m_frontRightModule.resetCurrentAngle();
        m_backLeftModule.resetCurrentAngle();
        m_backRightModule.resetCurrentAngle();
...
//    return Rotation2d.fromDegrees(360.0 - m_navx.getYaw());
  ...
  public void periodic() {
    //BLACKBIRD
    odometer.update(getRotation(), m_kinematics.toSwerveModuleStates(m_chassisSpeeds));
    SmartDashboard.putNumber("Robot Heading", getRotation().getDegrees());
    SmartDashboard.putString("Robot Location", getPose().getTranslation().toString());
    headingDegrees = getRotation().getDegrees();
    gyroHeading = Rotation2d.fromDegrees(m_pigeon.getFusedHeading());
    SmartDashboard.putNumber("gyro heading", m_pigeon.getFusedHeading());
